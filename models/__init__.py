from models.baselines.mcp import Networkx_Max_Clique
...
from models.fgnn.fgnn import (
    Simple_Edge_Embedding,
    Simple_Node_Embedding,
    RS_Edge_Embedding,
    RS_Node_Embedding,
)
...
DUMMY_MODELS = {
    "node_degree": {"edge": Edge_NodeDegree, "node": Node_NodeDegree},
    "nx": {"node": Networkx_Max_Clique},
}
...
DGL_EMBEDDING_DICT = {"edge": DGL_Edge, "node": DGL_Node}

MODULE_DICT = {
    "fgnn": {"edge": Simple_Edge_Embedding, "node": Simple_Node_Embedding},
    "rsfgnn": {"edge": RS_Edge_Embedding, "node": RS_Node_Embedding},
    "gatedgcn": {"edge": GatedGCNNet_Edge, "node": GatedGCNNet_Node},
    "gcn": {"edge": GCN_Edge, "node": GCN},
    "gin": {"edge": GINEdge, "node": GIN},
    "ginsimple": {"edge": GINEdgeSimple, "node": GIN},
    "gat": {"node": GAT},
}
