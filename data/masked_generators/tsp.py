...
class TSP_MT_Generator(Base_Generator):
    """
    ...
    def __init__(self, name, args, coeff=1e8):
        ...
        subfolder_name = 'TSP-MT_{}_{}_{}_{}_{}'.format(self.generative_model, 
                                                     self.distance,
                                                     num_examples,
                                                     self.min_vertices,
                                                     self.max_vertices)
        path_dataset = os.path.join(args['path_dataset'], 'tsp_mt', subfolder_name)
    ...
    def compute_example(self):
        ...
        """
        n_vertices = random.randrange(self.min_vertices, self.max_vertices+1)
        try:
            g, W = GENERATOR_FUNCTIONS_TSP[self.generative_model](n_vertices)
        except KeyError:
        ...
        SOL = torch.zeros((n_vertices,n_vertices),dtype=int)
